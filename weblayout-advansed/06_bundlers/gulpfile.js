...
exports.default = series(clean, resourses, svgSprites, images, htmlDist, styles, scripts, imageProd, stylesProd, scriptsProd, htmlProd, watchFiles)
// порядок действий которые выполняет сборщик:
// очистка=>перенос ресурсов=>создание спрайта обработка изображений=>
// =>перенос необработаного html в разработку компиляция JS и CSS в папку разработки=>
// =>перенос изображений в папку готового проекта =>
