...
// =>перенос необработаного html в разработку, перенос JS и CSS в папку разработки=>
// =>перенос изображений и шрифтов в папку готового проекта =>
// =>компиляция CSS, минификация и перенос всех HTML, CSS, JS , и  в папку готового проекта
